...
while (isNaN (metodoDePagamento) || metodoDePagamento <= 0 || metodoDePagamento > 3) {
  alert('Digite um valor válido 1, 2 ou 3')
  metodoDePagamento = prompt(`Informe o método de pagamento:
  Digite 1 para pagamento em dinheiro
  Digite 2 para pagamento em cheque
  Digite 3 para pagamento com cartão`)
}
